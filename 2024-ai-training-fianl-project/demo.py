...
class TestSet(Dataset):
    def __init__(self, lq_paths, gt_paths) -> None:
        ...
        self.imagelist1 = []
        self.imagelist2 = []
        print(lq_paths, gt_paths)
        for lq_path in lq_paths:
            print(lq_path)
            self.imagelist1 = self.imagelist1 + glob.glob(os.path.join(lq_path, '*.png'))
        for gt_path in gt_paths:
            print(gt_path)
            self.imagelist2 = self.imagelist2 + glob.glob(os.path.join(gt_path, '*.png'))
...
if __name__ == '__main__':
    ...
    state_dict = torch.load('/home/va8800/ken_ai/2024-ai-training-fianl-project/model.pth', map_location=device)
    model.load_state_dict(state_dict, strict=False)
    model.eval()

    test_ds = TestSet(lq_paths=['/home/va8800/ken_ai/2024-ai-training-fianl-project/Set5/LRbicx3'], gt_paths=['/home/va8800/ken_ai/2024-ai-training-fianl-project/Set5/original'])
